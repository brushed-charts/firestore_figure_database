...
void main() {
  ...
  group("Firestore load: ", () {
    test("Assert only figure related context is loaded", () async {
      figureDB.context = const FigureContext('EUR_USD', 'BROKER_1');
      figureDB.save(figureA);
      figureDB.save(figureB);
      figureDB.context = const FigureContext('EUR_GBP', 'BROKER_1');
      figureDB.save(figureC);
      figureDB.context = const FigureContext('EUR_USD', 'BROKER_2');
